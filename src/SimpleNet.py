...
class GomokuNet(nn.Module):
    def __init__(self, env):
        ...
        self.fc1 = nn.Linear(self.last_dim, 512).to(self.device)
        ...
        self.fc3 = nn.Linear(self.last_dim, 512).to(self.device)
        self.fc_bn3 = nn.BatchNorm1d(512).to(self.device)

        self.fc4 = nn.Linear(512, 128).to(self.device)
    ...
    def forward(self, s):
        ...
        v = F.relu(self.fc4(v)) # batch_size x 512                                               # batch_size x action_size
